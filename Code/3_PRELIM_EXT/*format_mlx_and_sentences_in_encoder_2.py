...
for split in ['train', 'validation', 'test']:
    ...
    # Export to json
    filename = '2mlx_clean_oreo_' + split + '.json'
    ds.to_json(filename)
...
# print dist
graphs.histogram(total_input_token_lengths, 'Number of Tokens for Sources Overall', 'Number of Tokens', 'Frequency', '2source_overall_tokens', log_y=False)
...
# print dist
graphs.histogram(sentence_token_lengths, 'Number of Tokens per Source Sentence', 'Number of Tokens', 'Frequency', '2source_sentence_tokens', log_y=False)
...
# print dist
graphs.histogram(est_encoder_sentences_list, 'Estimated Number of Sentences To Extract', 'Number of Sentences', 'Frequency', '2num_sentences_extract', log_y=False)
...
# print dist
graphs.histogram(input_sentences, 'Number of Sentences in Source', 'Number of Sentences', 'Frequency', '2sentences_in_source', log_y=False)
