# from https://github.com/Law-AI/summarization/tree/aacl/extractive/MMR
# Implementation of the paper Automatic Summarization of Legal Decisions using Iterative Masking of Predictive Sentences ICAIL, 2019

# python MMR.py --data_path /path/to/documents/ --summary_path /path.to/save/summaries/ --length_file lengthfile.txt
# length file format filename <TAB> required-summary-length-in-words
