...
model = BertForSequenceClassification.from_pretrained("legal-bert-base-uncased", num_labels=2)
tokenizer = BertTokenizer.from_pretrained('legal-bert-base-uncased', do_lower_case=True)
