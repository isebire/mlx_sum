...
# Actually do it
python ft_bert_2.py --gpu --trainFile ${DATA_SCRATCH}/sample_train.tsv --devFile ${DATA_SCRATCH}/sample_val.tsv --testFile ${DATA_SCRATCH}/sample_test.tsv --outputDir ${OUTPUT_DIR}/test_output --input_dir ${DATA_SCRATCH}
