...
def box_plot(list_of_lists, group_names, title, x_label, y_label, filename, positions=False, long_labels=False):
    ...
    # Creating plot
    if positions:
        bp = ax.boxplot(list_of_lists, patch_artist = True, positions=[0,1,2,4,5,7,8])  #[0,1,3,4,6,7])
    else:
    ...
    if positions:
        colors = ['#911c43', '#cc4170', '#f79ebc', '#f9e096', '#fff2cc', '#5c509d', '#bfb6f0']
    else:
