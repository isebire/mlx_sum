# Just inference!
# Remember to change things marked with ***
...
def main(args):
    ...
    # *** Path of the trained model, will be of form eg f"{args.output_dir}/trained_pegasus_1"
    MODEL_PATH = f"{args.output_dir}/trained_pegasus_1"
    ...
    # *** filename
    filename = f"{args.output_dir}/PIPELINE_outputs_pegasus_5.csv"
