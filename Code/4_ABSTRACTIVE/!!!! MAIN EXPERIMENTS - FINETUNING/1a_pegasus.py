# 1A: First 1024, CNN/DM Pegasus, No entity chaining
...
def main(args):
    ...
    training_args = Seq2SeqTrainingArguments(
        # *** Output dir
        output_dir=f"{args.output_dir}/" + "pegasus_1a",
    ...
    # *** Model name
    output_model_fn = 'trained_pegasus_1a'
    ...
    # *** filename
    filename = f"{args.output_dir}/outputs_pegasus_1a.csv"
