# 1C2: OREO sentences, CNN/DM Pegasus, No entity chaining
...
def main(args):
    ...
    for split in ['train', 'validation']:
        ...
        mlx[split] = mlx_split
    fn = f"{args.input_dir}/mlx_pegasus_short_bert_sents_test.hf"
    mlx_test = load_from_disk(fn)
    mlx['test'] = mlx_test
    ...
    training_args = Seq2SeqTrainingArguments(
        # *** Output dir
        output_dir=f"{args.output_dir}/" + "pegasus_1c2",
    ...
    # *** Model name
    output_model_fn = 'trained_pegasus_1c2'
    ...
    # *** filename
    filename = f"{args.output_dir}/outputs_pegasus_1c2.csv"
