# 1D: OREO windows, CNN/DM Pegasus, No entity chaining
...
def main(args):
    ...
    training_args = Seq2SeqTrainingArguments(
        # *** Output dir
        output_dir=f"{args.output_dir}/" + "pegasus_1d",
    ...
    # *** Model name
    output_model_fn = 'trained_pegasus_1d'
    ...
    # *** filename
    filename = f"{args.output_dir}/outputs_pegasus_1d.csv"
