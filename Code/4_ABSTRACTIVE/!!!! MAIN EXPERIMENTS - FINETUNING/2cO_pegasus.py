# 2cO: OREO sent inputs, Legal Pegasus, No entity chaining
...
def main(args):
    ...
    training_args = Seq2SeqTrainingArguments(
        # *** Output dir
        output_dir=f"{args.output_dir}/" + "pegasus_2cO",
    ...
    # *** Model name
    output_model_fn = 'trained_pegasus_2cO'
    ...
    # *** filename
    filename = f"{args.output_dir}/outputs_pegasus_2cO.csv"
