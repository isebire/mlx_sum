# 2d: OREO / BERT window inputs, Legal Pegasus, No entity chaining
...
def main(args):
    ...
    training_args = Seq2SeqTrainingArguments(
        # *** Output dir
        output_dir=f"{args.output_dir}/" + "pegasus_2d",
    ...
    # *** Model name
    output_model_fn = 'trained_pegasus_2d'
    ...
    # *** filename
    filename = f"{args.output_dir}/outputs_pegasus_2d.csv"
