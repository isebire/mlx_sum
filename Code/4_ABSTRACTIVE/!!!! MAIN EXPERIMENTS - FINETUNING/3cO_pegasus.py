# 3cO: OREO sent inputs, Legal Pegasus, surface entity chaining
...
def main(args):
    ...
    training_args = Seq2SeqTrainingArguments(
        # *** Output dir
        output_dir=f"{args.output_dir}/" + "pegasus_3cO",
    ...
    # *** Model name
    output_model_fn = 'trained_pegasus_3cO'
    ...
    # *** filename
    filename = f"{args.output_dir}/outputs_pegasus_3cO.csv"
