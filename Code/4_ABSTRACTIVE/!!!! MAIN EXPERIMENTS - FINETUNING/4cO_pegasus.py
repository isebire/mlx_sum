# 4cO: OREO sent inputs, Legal Pegasus, label entity chaining
...
def main(args):
    ...
    training_args = Seq2SeqTrainingArguments(
        # *** Output dir
        output_dir=f"{args.output_dir}/" + "pegasus_4cO",
    ...
    # *** Model name
    output_model_fn = 'trained_pegasus_4cO'
    ...
    # *** filename
    filename = f"{args.output_dir}/outputs_pegasus_4cO.csv"
