# 4d: OREO/BERT window inputs, Legal Pegasus, label entity chaining
...
def main(args):
    ...
    def preprocess_pegasus(cases):
        ...
        outputs = cases["summary/short_chain_label"]
        if chain:
    ...
    training_args = Seq2SeqTrainingArguments(
        # *** Output dir
        output_dir=f"{args.output_dir}/" + "pegasus_4d",
    ...
    # *** Model name
    output_model_fn = 'trained_pegasus_4d'
    ...
    # *** Column name
    text = mlx['test'][0]['summary/short_chain_label']
    ...
    for i, case in enumerate(mlx['test']):
        ...
        # *** target col
        gold = case['summary/short_chain_label']
        case_data['gold'] = gold
    ...
    # *** filename
    filename = f"{args.output_dir}/outputs_pegasus_4d.csv"
