# 5cO: OREO sent inputs, Legal Pegasus, combined entity chaining
...
def main(args):
    ...
    training_args = Seq2SeqTrainingArguments(
        # *** Output dir
        output_dir=f"{args.output_dir}/" + "pegasus_5cO",
    ...
    # *** Model name
    output_model_fn = 'trained_pegasus_5cO'
    ...
    # *** filename
    filename = f"{args.output_dir}/outputs_pegasus_5cO.csv"
