# 5d: OREO/BERT window inputs, Legal Pegasus, combined entity chaining
...
def main(args):
    ...
    def preprocess_pegasus(cases):
        ...
        outputs = cases["summary/short_chain_both"]
        if chain:
    ...
    training_args = Seq2SeqTrainingArguments(
        # *** Output dir
        output_dir=f"{args.output_dir}/" + "pegasus_5d",
    ...
    # *** Model name
    output_model_fn = 'trained_pegasus_5d'
    ...
    # *** Column name
    text = mlx['test'][0]['summary/short_chain_both']
    ...
    # *** filename
    filename = f"{args.output_dir}/outputs_pegasus_5d.csv"
