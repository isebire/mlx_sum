# This is a v simple eg to check special tokens are actually geenrated
...
def main(args):
    ...
    def preprocess_pegasus(cases):
        ...
        labels = tokenizer(text_target=['[ENTITYCHAIN] Test Inc. [CONTENTSPLIT] This is a test.' for i in cases["summary/short_chain_surface"]], max_length=1024, truncation=True)    #return_tensors='pt' needed???
    ...
    training_args = Seq2SeqTrainingArguments(
        # *** Output dir
        output_dir=f"{args.output_dir}/" + "pegasus_3_TOKEN_TEST_BASIC",
    ...
    # *** Model name
    output_model_fn = 'trained_pegasus_3_TOKEN_TEST_BASIC'
    ...
    # *** filename
    filename = f"{args.output_dir}/outputs_pegasus_3_TOKEN_TEST_BASIC.csv"
