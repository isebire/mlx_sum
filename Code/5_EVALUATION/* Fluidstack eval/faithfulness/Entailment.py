...
class Entailment(MetricInterface):
    ...
    def __documentwise_entailment(self, summary, source) -> PRF1Result:
        ...
        #     print('Score?????')
        #     print(score[variant])
        #     # idk really why this works but score is indeed the entailment probability
        #     # if variant is True: is sentence entailed by source?
        #     # if variant is False: is source entailed by sentence?
        #
        # print('*****')
        # precision = score[True]
        # recall = score[False]
