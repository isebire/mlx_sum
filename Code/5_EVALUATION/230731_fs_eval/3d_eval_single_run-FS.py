...
def main(args):
    ...
    if ANALYSE_BERT:
        ...
        for idx, case in results_df.iterrows():
            ...
            # fixing an error:
            if idx == 541:
                generated_segmented = 'Parkview Medical Center and Parlcview Medical Center reached a settlement in a lawsuit filed under the Americans with Disabilities Act (ADA) in the U.S. District Court for the District of Colorado.[SENTMARKER] The parties entered into a settlement agreement in July 2013 to resolve all claims and controversies between them, including but not limited to the lawsuit.[SENTMARKER] Under the terms of the settlement agreement, Parkview will pay a total of $65,00 (sixty-five thousand dollars) to the plaintiff.[SENTMARKER] The settlement agreement is subject to court approval.'
                generated = '[ENTITYCHAIN] [CONTENTSPLIT] Parkview Medical Center and Parlcview Medical Center reached a settlement in a lawsuit filed under the Americans with Disabilities Act (ADA) in the U.S. District Court for the District of Colorado. The parties entered into a settlement agreement in July 2013 to resolve all claims and controversies between them, including but not limited to the lawsuit. Under the terms of the settlement agreement, Parkview will pay a total of $65,00 (sixty-five thousand dollars) to the plaintiff. The settlement agreement is subject to court approval.'
